...
{
    /// <inheritdoc />
    public class FullTextSearchJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Turbopuffer.FullTextSearch>
    {
        /// <inheritdoc />
        public override global::Turbopuffer.FullTextSearch Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("case_sensitive")) __score1++;
            if (__jsonProps.Contains("k1")) __score1++;
            if (__jsonProps.Contains("language")) __score1++;
            if (__jsonProps.Contains("max_token_length")) __score1++;
            if (__jsonProps.Contains("remove_stopwords")) __score1++;
            if (__jsonProps.Contains("stemming")) __score1++;
            ...
            bool? fullTextSearchVariant1 = default;
            global::Turbopuffer.FullTextSearchConfig? config = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::Turbopuffer.FullTextSearch(
        ...
        public override void Write(
            ...
            global::Turbopuffer.FullTextSearch value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsFullTextSearchVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(bool), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<bool> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(bool).Name}");
