...
namespace Turbopuffer
{
    public partial class TurbopufferClient
    {
        ...
        private static readonly global::Turbopuffer.EndPointSecurityRequirement s_CreateNamespacesByNamespaceQuerySecurityRequirement0 =
        ...
        private static readonly global::Turbopuffer.EndPointSecurityRequirement[] s_CreateNamespacesByNamespaceQuerySecurityRequirements =
            new global::Turbopuffer.EndPointSecurityRequirement[]
            {                s_CreateNamespacesByNamespaceQuerySecurityRequirement0,
            };
        partial void PrepareCreateNamespacesByNamespaceQueryArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @namespace,
            global::Turbopuffer.AllOf<global::Turbopuffer.QueryConfig, global::Turbopuffer.Query> request);
        partial void PrepareCreateNamespacesByNamespaceQueryRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @namespace,
            global::Turbopuffer.AllOf<global::Turbopuffer.QueryConfig, global::Turbopuffer.Query> request);
        partial void ProcessCreateNamespacesByNamespaceQueryResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateNamespacesByNamespaceQueryResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Turbopuffer.QueryResult> CreateNamespacesByNamespaceQueryAsync(
            string @namespace,
        ...
        {
            var __response = await CreateNamespacesByNamespaceQueryAsResponseAsync(
                @namespace: @namespace,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Turbopuffer.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Turbopuffer.AutoSDKHttpResponse<global::Turbopuffer.QueryResult>> CreateNamespacesByNamespaceQueryAsResponseAsync(
            string @namespace,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreateNamespacesByNamespaceQueryArguments(
            ...
            var __authorizations = global::Turbopuffer.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateNamespacesByNamespaceQuerySecurityRequirements,
                operationName: "CreateNamespacesByNamespaceQueryAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Turbopuffer.PathBuilder(
                                path: $"/v2/namespaces/{@namespace}/query",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateNamespacesByNamespaceQueryRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Turbopuffer.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Turbopuffer.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createNamespacesByNamespaceQuery",
                                methodName: "CreateNamespacesByNamespaceQueryAsync",
                                pathTemplate: "$\"/v2/namespaces/{@namespace}/query\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateNamespacesByNamespaceQueryResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Turbopuffer.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateNamespacesByNamespaceQueryResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Turbopuffer.QueryResult.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Turbopuffer.AutoSDKHttpResponse<global::Turbopuffer.QueryResult>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Turbopuffer.QueryResult.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateNamespacesByNamespaceQueryAsync(
                @namespace: @namespace,
                request: __request,
                requestOptions: requestOptions,
