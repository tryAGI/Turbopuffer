...
namespace Turbopuffer
{
    public partial class TurbopufferClient
    {
        ...
        private static readonly global::Turbopuffer.EndPointSecurityRequirement s_CreateNamespacesByNamespaceSecurityRequirement0 =
        ...
        private static readonly global::Turbopuffer.EndPointSecurityRequirement[] s_CreateNamespacesByNamespaceSecurityRequirements =
            new global::Turbopuffer.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::Turbopuffer.WriteResult> CreateNamespacesByNamespaceAsync(
            string @namespace,
        ...
        {
            var __response = await CreateNamespacesByNamespaceAsResponseAsync(
                @namespace: @namespace,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Turbopuffer.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Turbopuffer.AutoSDKHttpResponse<global::Turbopuffer.WriteResult>> CreateNamespacesByNamespaceAsResponseAsync(
            string @namespace,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Turbopuffer.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Turbopuffer.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createNamespacesByNamespace",
                                methodName: "CreateNamespacesByNamespaceAsync",
                                pathTemplate: "$\"/v2/namespaces/{@namespace}\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Turbopuffer.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Turbopuffer.WriteResult.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Turbopuffer.AutoSDKHttpResponse<global::Turbopuffer.WriteResult>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Turbopuffer.WriteResult.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Turbopuffer.WriteResult> CreateNamespacesByNamespaceAsync(
            string @namespace,
            global::Turbopuffer.Columns? upsertColumns = default,
            global::System.Collections.Generic.IList<global::Turbopuffer.Row>? upsertRows = default,
            global::Turbopuffer.Columns? patchColumns = default,
            global::System.Collections.Generic.IList<global::Turbopuffer.Row>? patchRows = default,
            global::System.Collections.Generic.IList<global::Turbopuffer.Id>? deletes = default,
