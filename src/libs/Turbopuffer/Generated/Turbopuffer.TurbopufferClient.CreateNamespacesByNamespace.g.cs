                    ...
                    await global::Turbopuffer.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Turbopuffer.WriteResult.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Turbopuffer.WriteResult.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
