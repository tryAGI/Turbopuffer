                    ...
                    await global::Turbopuffer.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Turbopuffer.GetNamespacesHintCacheWarmResponse.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Turbopuffer.GetNamespacesHintCacheWarmResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
