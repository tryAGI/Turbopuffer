...
{
    /// <inheritdoc />
    public class AnnJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Turbopuffer.Ann>
    {
        /// <inheritdoc />
        public override global::Turbopuffer.Ann Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            var __score1 = 0;
            if (__jsonProps.Contains("distance_metric")) __score1++;
            var __bestScore = 0;
            var __bestIndex = -1;
            ...
            global::Turbopuffer.AnnConfig? config = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Turbopuffer.AnnConfig), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Turbopuffer.AnnConfig> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Turbopuffer.AnnConfig).Name}");
            ...
            var __value = new global::Turbopuffer.Ann(
                annVariant1,
